...
use App\Http\Requests\ { MessageAd, EmailUpdate, AdresseUpdate };
...
class UserController extends Controller
{
    ...
    {
        return view('user.adresse');
    }

    public function adresseUpdate(AdresseUpdate $request)
    {
        auth()->user()->adresse = $request->adresse;
        auth()->user()->save();

        $request->session()->flash('status', "Votre adresse a bien été mis à jour.");
